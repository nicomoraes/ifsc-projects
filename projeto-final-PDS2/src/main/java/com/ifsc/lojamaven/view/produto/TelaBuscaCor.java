...
public class TelaBuscaCor extends javax.swing.JDialog {
  ...
  public TelaBuscaCor(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  public static void main(String[] args) {
    ...
    java.awt.EventQueue.invokeLater(() -> {
      TelaBuscaCor dialog = new TelaBuscaCor(new javax.swing.JFrame(), true);
  ...
  private void initComponents() {
    ...
    jLabelTitulo.setText("Busca Cores");
