...
public class TelaCadastroCor extends javax.swing.JFrame {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(TelaCadastroCor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new TelaCadastroCor().setVisible(true);
      }
    });
  }
  ...
  private void initComponents() {
    ...
    jLabelTitulo.setText("Cadastro de Cores");
