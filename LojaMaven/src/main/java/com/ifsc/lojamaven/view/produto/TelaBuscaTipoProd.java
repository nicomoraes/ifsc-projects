...
public class TelaBuscaTipoProd extends javax.swing.JDialog {
  ...
  public TelaBuscaTipoProd(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  public static void main(String[] args) {
    ...
    java.awt.EventQueue.invokeLater(() -> {
      TelaBuscaTipoProd dialog = new TelaBuscaTipoProd(new javax.swing.JFrame(), true);
  ...
  private void initComponents() {
    ...
    jLabelTitulo.setText("Busca de Tipos de Produtos");
