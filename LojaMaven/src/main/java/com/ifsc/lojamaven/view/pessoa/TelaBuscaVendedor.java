...
public class TelaBuscaVendedor extends javax.swing.JDialog {
  ...
  public TelaBuscaVendedor(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  public static void main(String[] args) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        TelaBuscaVendedor dialog = new TelaBuscaVendedor(new javax.swing.JFrame(), true);
  ...
  private void initComponents() {
    ...
    jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String[]{
                    "ID", "Nome", "E-mail", "CPF", "Endereço", "Fone"
            }
    ) {
    ...
    jLabelTitulo.setText("Busca Vendedor");
