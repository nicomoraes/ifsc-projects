...
public class TelaBuscaCaractProd extends javax.swing.JDialog {
  ...
  public TelaBuscaCaractProd(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  public static void main(String[] args) {
    ...
    java.awt.EventQueue.invokeLater(() -> {
      TelaBuscaCaractProd dialog = new TelaBuscaCaractProd(new javax.swing.JFrame(), true);
  ...
  private void initComponents() {
    ...
    jLabelTitulo.setText("Busca Características de Produtos");
    ...
    jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String[]{
                    "ID", "Produto", "Cor", "Tamanho", "Quant. Estoque"
            }
    ) {
